...
#define LED0_PIN    Pin_15 // PA15 (LED)
#define LED1_GPIO   GPIOC
#define LED1_PIN    Pin_10 // PC10 (LED)
#define BEEP_GPIO   GPIOB
#define BEEP_PIN    Pin_9  // PB9 (Buzzer)
#define BARO_GPIO   GPIOB
#define BARO_PIN    Pin_5
#define INV_PIN     Pin_6 //  PB6 (BOOT1) abused as inverter select GPIO
...
#define BEEP_OFF                 beepPWMOff();//systemBeep(false);
#define BEEP_ON                  beepPWMOn();//systemBeep(true);
#else
#define BEEP_TOGGLE              ;
#define BEEP_OFF                 ;
#define BEEP_ON                  ;
