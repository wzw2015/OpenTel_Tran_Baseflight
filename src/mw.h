...
typedef struct config_t {
    ...
    // stickknob adc-edge & adc-middle
		uint16_t adcLimitHigh[5];         
	  uint16_t adcLimitLow[5];
		uint16_t adcLimitMiddle[5];
...
extern uint16_t btnChannel[5];

extern RFDevice RFDev[RF_DEV_SUM];  
