...
//Beep使用TIM4 CH4生成PWM波形
//  TIM4 CH4，对应numMorots= PWM14
#define BEEP_PWM  PWM14
static pwmPortData_t *beepPWM;

void beepPWMInit(void)
{
    beepPWM = pwmOutConfig(BEEP_PWM, PWM_TIMER_8_MHZ, PWM_TIMER_8_MHZ*1000000/2000, 0);   	
}
